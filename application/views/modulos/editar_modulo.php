		  ...
		  <div class="row">
				<div class="col-md-12">  
					<div class="page-header">
						<h1><i class="fa fa-cogs"></i> Panel de control <small>Modulos/editar modulo</small></h1>
							...
							<div class="row"  id="icons">
								<div class="col-md-12">
									<ol class="breadcrumb">
										...
										<li class="active">Editar modulo</li>
									</ol>
									<div class="row">
										<div class="col-md-6 col-md-offset-3">
											...
											<?php $attributes = array('id' => 'formEditarModulo','name' => 'formEditarModulo'); echo form_open('modulos/guardar_cambios_modulo',$attributes); ?>
												...
												<div class="form-group">
													...
													<div class="input-group">
														    ...
														    <input type="text" class="form-control input-lg" id="NombreModulo" name="NombreModulo" placeholder="Nombre de modulo" value="<? echo $modulo['NombreModulo']?>">
														    <input type="hidden" class="form-control input-lg" id="IdModulo" name="IdModulo" value="<? echo $modulo['IdModulo']?>">
													</div>
												</div>
