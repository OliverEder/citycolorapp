<!-- /.Formulario log in -->
<div class="modal fade bs-example-modal-sm" id="alerta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php $attributes = array('id' => 'formularioLogIn','name' => 'formularioLogIn'); echo form_open('usuarios/login',$attributes); ?>
          ...
          <div class="form-group">
            <label for="message-text" class="control-label" id="PassUsuario">Contraseña:<div > </div></label>
            <div class="input-group">
