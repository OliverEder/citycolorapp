		  ...
		  <div class="row">
				<div class="col-md-12">  
					<div class="page-header">
						<h1><i class="fa fa-cogs"></i> Panel de control <small>Usuarios/editar usuario</small></h1>
								...
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-6 col-md-offset-3">
											...
											<?php $attributes = array('id' => 'formEditarUsuario','name' => 'formEditarUsuario'); echo form_open('usuarios/guardar_cambios_usuario',$attributes); ?>
												<div class="form-group">
													<label for="recipient-name" class="control-label" id="MensajeUsuario" >Usuario:<div > </div></label>
													<div class="input-group">
														    <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></span>
														    <input type="text" class="form-control input-lg" id="NombreUsuario" name="NombreUsuario" placeholder="Nombre de usuario" value="<? echo $usuario['NombreUsuario']?>">
														    <input type="hidden" class="form-control input-lg" id="IdUsuario" name="IdUsuario" value="<? echo $usuario['IdUsuario']?>">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="input-group">
														    ...
														    <input type="password" class="form-control input-lg" id="PasswordUsuario" name="PasswordUsuario" placeholder="Password" value="<? echo $usuario['PasswordUsuario']?>">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="input-group">
														    <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></span>
														    <input type="password" class="form-control input-lg" id="ConfirmaPassUsuario" name="ConfirmaPassUsuario" placeholder="Confirmacion" value="<? echo $usuario['PasswordUsuario']?>">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="input-group">
														    ...
														    <input type="email" class="form-control input-lg" id="EmailUsuario" name="EmailUsuario" placeholder="E-mail" value="<? echo $usuario['EmailUsuario']?>">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="input-group">
														    ...
														    <select class="form-control" id="RangoUsuario" name="RangoUsuario">
																	<option value="<? echo $usuario['IdRango']?>"><? echo $usuario['NombreRango']?></option>
