		  ...
		  <div class="row">
				<div class="col-md-12">  
					<div class="page-header">
						<h1><i class="fa fa-cogs"></i> Panel de control <small>Rangos/nuevo rango</small></h1>
							...
							<div class="row"  id="icons">
								<div class="col-md-12">
									<ol class="breadcrumb">
										...
										<li class="active">Nuevo rango</li>
									</ol>
									<div class="row">
										<div class="col-md-6 col-md-offset-3">
											...
											<?php $attributes = array('id' => 'formNuevoRango','name' => 'formNuevoRango'); echo form_open('usuarios/login',$attributes); ?>
												<div class="form-group">
													...
													<div class="input-group">
														    ...
														    <input type="text" class="form-control input-lg" id="NombreRango" name="NombreRango" placeholder="Nombre de rango">
													</div>
												</div>
