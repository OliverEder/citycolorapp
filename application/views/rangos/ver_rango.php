		  ...
		  <div class="row">
				<div class="col-md-12">  
					<div class="page-header">
						<h1><i class="fa fa-cogs"></i> Panel de control <small>Rangos/ver rango</small></h1>
								...
								<div class="col-md-12">
									...
									<table class="table table-hover">
										...
										<tr>
											...
											<td><strong><? echo $rango['IdRango']?></strong></td>
										</tr>
										<tr>
											<td><strong>Rango</strong></td>
											<td><strong><? echo $rango['NombreRango']?></strong></td>
										</tr>
