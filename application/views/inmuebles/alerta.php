<!-- /.Formulario log in -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php $attributes = array('id' => 'alerta','name' => 'alerta'); echo form_open('inmuebles/eliminar',$attributes); ?>
          <div class="form-group">
            <label for="recipient-name" class="control-label" id="MensajeUsuario" >¿Deseas eliminar este registro? <div > </div></label>
            <div class="input-group">
                  
                  <input type="hidden" class="form-control input-lg" id="IdInmueble" name="IdInmueble" value="<? echo $inmueble?>">
            </div>
          </div>
