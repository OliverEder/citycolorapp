		  ...
		  <div class="row">
				<div class="col-md-12">  
					<div class="page-header">
						<h1><i class="fa fa-cogs"></i> Panel de control <small>Hidraulico/nueva accesorio</small></h1>
							...
							<div class="row"  id="icons">
								<div class="col-md-12">
									<ol class="breadcrumb">
										...
										<li class="active">Nuevo accesorio</li>
									</ol>
									<div class="row">
										<div class="col-md-6 col-md-offset-3">
											...
											<?php $attributes = array('id' => 'formNuevoAccesorio','name' => 'formNuevoAccesorio'); echo form_open('accesorios/registro_accesorio',$attributes); ?>
												<div class="form-group">
													...
													<div class="input-group">
														    ...
														    <input type="text" class="form-control input-lg" id="NombreAccesorio" name="NombreAccesorio" placeholder="Nombre">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="input-group">
														    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-tint"></i></span>
														    <input type="text" class="form-control input-lg" id="MarcaAccesorio" name="MarcaAccesorio" placeholder="Marca">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="input-group">
														    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-tint"></i></span>
														    <input type="text" class="form-control input-lg" id="EstadoAccesorio" name="EstadoAccesorio" placeholder="Estado fisco/higienico">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="input-group">
														    ...
														    <input type="date" class="form-control input-lg date-piker" id="FechaUltimoMantoAccesorio" name="FechaUltimoMantoAccesorio" placeholder="Fecha de mantenimiento">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="input-group">
														    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-tint"></i></span>
														    <textarea class="form-control" id="DescripcionAccesorio" name="DescripcionAccesorio" placeholder="Descripccion" rows="3"></textarea>
													</div>
												</div>
