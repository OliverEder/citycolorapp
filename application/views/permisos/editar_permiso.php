		  ...
		  <div class="row">
				<div class="col-md-12">  
					<div class="page-header">
						<h1><i class="fa fa-cogs"></i> Panel de control <small>Permisos/editar permiso</small></h1>
								...
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-6 col-md-offset-3">
											...
											<?php $attributes = array('id' => 'formEditarPermiso','name' => 'formEditarPermiso'); echo form_open('permisos/guardar_cambios_permiso',$attributes); ?>
												...
												<div class="form-group">
													...
													<input type="hidden" class="form-control input-lg" id="IdPermiso" name="IdPermiso" value="<? echo $permiso['IdPermiso']?>">
													<div class="input-group">
														    ...
														    <select class="form-control" id="IdRango" name="IdRango">
																	<option value="<? echo $permiso['IdRango']?>"><? echo $permiso['NombreRango']?></option>
												...
												<div class="form-group">
													...
													<div class="input-group">
														    ...
														    <select class="form-control" id="IdModulo" name="IdModulo">
																	<option value="<? echo $permiso['IdModulo']?>"><? echo $permiso['NombreModulo']?></option>
